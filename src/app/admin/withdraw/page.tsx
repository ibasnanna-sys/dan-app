      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-5 py-6 pb-32">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6 mb-10">
          ...
          <div>
            ...
            <p className="text-zinc-500 mt-5 max-w-2xl leading-relaxed">
              Kelola approval withdraw
              member DAN secara realtime.
            </p>
        ...
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-4 mb-8">
          ...
          <div className="rounded-3xl border border-yellow-500/20 bg-yellow-500/10 p-5">
            ...
            <h2 className="text-3xl font-black mt-4 text-yellow-300">
              {stats.pending}
            </h2>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mb-8">
          ...
          <div className="relative xl:col-span-2">
            ...
            <input
              ...
              className="w-full h-16 rounded-3xl bg-zinc-950 border border-zinc-800 pl-14 pr-5 outline-none focus:border-green-500"
            />
