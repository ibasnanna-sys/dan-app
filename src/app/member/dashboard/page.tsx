  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <div className="max-w-6xl mx-auto px-5 py-6 md:px-8">
        ...
        <Link
          href="/member/produk"
          className="relative overflow-hidden mt-6 flex items-center justify-between rounded-[32px] bg-green-500 hover:bg-green-400 transition p-6 shadow-[0_0_40px_rgba(34,197,94,0.35)]"
        >
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-black text-3xl md:text-4xl font-black mt-2">
              Aktivasi Member
            </h2>

            <p className="text-black/70 mt-2 text-sm">
              Aktivasi akun & mulai belanja paket data digital
            </p>
          </div>

          <div className="relative z-10 w-16 h-16 rounded-2xl bg-black/10 flex items-center justify-center">
